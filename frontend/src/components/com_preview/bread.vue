<template>
  <div class="design">
        <VueDragResize  v-show="info.isshown" :isDraggable="false" :isResizable="false"
        v-on:clicked="showinformation" :z="10" :isActive="true" :w="info.width" :h="info.height" :x="info.left" :y="info.top" v-on:resizing="resize" v-on:dragging="resize">
            <div :style="{'position':'relative'}" :width="info.width" :height="info.height">
                ...
                <el-breadcrumb-item>第二级</el-breadcrumb-item>
                <el-breadcrumb-item>第三级</el-breadcrumb-item>
                <el-breadcrumb-item>第四级</el-breadcrumb-item>
            </el-breadcrumb>
