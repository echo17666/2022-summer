<template>
  <div class="design">
        ...
        :z="10" v-on:clicked="showinformation" :isActive="true" :w="info.width" :h="info.height" :x="info.left" :y="info.top" v-on:resizing="resize" v-on:dragging="resize">
            <div :style="{'position':'relative'}">
              <el-avatar :fit="fill" :src="url" :width="info.width" :height="info.height"></el-avatar>
