<template>
  <div class="design">
        <VueDragResize  v-show="info.isshown" :isDraggable="false" :isResizable="false" :z="10" v-on:clicked="showinformation" :isActive="true" :w="info.width" :h="info.height" :x="info.left" :y="info.top" v-on:resizing="resize" v-on:dragging="resize">
